...
import { useGetBeautyProductsQuery } from "../redux/services/hmServices";
...
export const BeautyProducts = () => {
  ...
  const { data: beautyProductData, isFetching: beautyProductDataFetching } =
  ...
  return (
    <div className="w-full">
      <div className="flex flex-row flex-wrap justify-center  md:gap-10  py-8  ml-0 lg:ml-72">
        {beautyProductData.results.map((item, i) => (
          <div
            key={i}
