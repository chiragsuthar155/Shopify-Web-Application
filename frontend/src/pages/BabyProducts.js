...
import { useGetBabyProductsQuery } from "../redux/services/hmServices";
...
export const BabyProducts = () => {
  ...
  const { data: babyData, isFetching: isFetchingBabyData } =
    useGetBabyProductsQuery();
  if (isFetchingBabyData)
    return (
